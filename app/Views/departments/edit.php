...
<div class="page-wrap">
    <div class="page-header">
        ...
        <p class="sub">Perbarui nama unit atau divisi</p>
    </div>
        ...
        <form action="/departments/update/<?= $department['id'] ?>" method="post">
            ...
            <div class="form-fields">
                <div class="form-row">
                    ...
                    <input type="text" id="name" name="department_name" value="<?= esc($department['department_name']) ?>" placeholder="Nama departemen" required>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="/departments" class="btn-back">Kembali</a>
            </div>
        </form>
    </div>
</div>
